...
export default function Component() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 via-blue-500 to-cyan-500 flex flex-col items-center justify-center p-4 md:p-8">
      <div className="max-w-4xl w-full space-y-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <Button variant="link" className="text-white hover:text-purple-200 text-lg">
            Talk to an expert
      ...
      <div className="mt-16 text-white/60 flex items-center space-x-2">
        <span>LuplegX acquires Warrant</span>
