            ...
            <div className="flex flex-col justify-center space-y-4 text-primary-foreground">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                  Elevate Your Career with Academy
                </h1>
                <p className="max-w-[600px] text-primary-foreground/80 md:text-xl">
                  Our academy consists of programs designed to help you grow
                  your skills and advance your career. You will learn from
              ...
              <div className="w-full max-w-sm space-y-2">
                ...
                <p className="text-xs text-primary-foreground/80">
                  Join our academy and get personalized feedback on your work
