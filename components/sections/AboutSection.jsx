  ...
  return (
    <div className="bg-blue-50 p-8 mt-20 rounded-lg">
      <div className="flex items-start mb-8">
        ...
        <div>
          <h2 className="text-3xl font-bold text-green-950 mb-2">Purpose</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
            <div className="w-8 h-8 bg-green-100 text-green-600 rounded-sm flex items-center justify-center font-bold mb-4">
              {card.number}
            </div>
            <h3 className="text-lg font-bold text-green-950 mb-2">{card.title}</h3>
