...
const allTips = [
  { title: "Type Predicates", duration: "1 min" },
  { title: "TypeScript 5.1 Beta is OUT!", duration: "2 mins", link: "/tips/beta" },
  { title: "How to Name your Types", duration: "4 mins" },
  { title: "Don't use return types, unless...", duration: "4 mins" },
  { title: "Understanding Generic Types", duration: "3 mins" },
  { title: "Advanced TypeScript Interfaces", duration: "5 mins" },
  { title: "Mastering Union and Intersection Types", duration: "4 mins" },
]
    ...
    <div className="min-h-screen bg-[#0a0b14] text-white  mb-10 p-8 flex flex-col items-center justify-start">
      <div className="w-full max-w-3xl space-y-8">
        ...
        <p className="text-lg text-center text-gray-400">
          A collection of useful tips that you wish you<br />
        ...
        <div className="space-y-4">
          {tips.map((tip, index) => (
            <div key={index} className="flex items-center space-x-4 bg-[#1a1b26] p-4 rounded-md">
        ...
        {tips.length === 0 && (
          <p className="text-center text-gray-500">No tips found matching your search.</p>
        )}
      </div>
    </div>
  )
