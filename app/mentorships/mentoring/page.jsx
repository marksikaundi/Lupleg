    ...
    <div>
      ...
      <div className="mb-8 mt-16">
        <img
          ...
          height={150}
        />
        <h1 className="text-4xl font-bold mb-4 text-green-950">Share your knowledge with others</h1>
        <p className="text-lg mb-4">
          <span className="text-blue-600 font-medium">Mentoring</span> is a fun and rewarding way to reinforce your own learning, while helping
          others learn and discover things they don't know. <span className="text-green-800 font-medium">Mentoring also earns reputation.</span>
        </p>
      </div>
      ...
      <div className="flex justify-center space-x-4">
        ...
        <Button variant="outline" className="border-green-950 text-green-950 hover:bg-green-50 px-6 py-2 rounded-full">
          Log in
        </Button>
      </div>
