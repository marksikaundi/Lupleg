      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="md:col-span-2 space-y-6">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-400">
                    January 19th, 2025 | 21:1 | 0
                  </p>
                </div>
              </div>
              <p className="mb-4">
                This day will focus on introducing two fundamental libraries in
                Python for data science: NumPy and Pandas. We'll cover the
                basics of these libraries and demonstrate how to perform basic
                data manipulation and analysis.
              </p>
              <p className="mb-4">
                NumPy (Numerical Python) is a powerful library for numerical
                computing in Python. It provides support for arrays, matrices,
                and many mathematical functions to operate on these data
                structures.
              </p>
          ...
          <Card>
            <CardHeader>
              <CardTitle>
              Python Libraries for Data Science you need to know
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-zinc-600 mb-4">
                Today, we'll cover the basics of NumPy and Pandas, two
                fundamental libraries in Python for data science. We'll
                demonstrate how to use these libraries to perform basic data
