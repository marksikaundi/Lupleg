    ...
    steps: [
      {
        ...
        description:
          "Analyze e-commerce platform requirements and identify entities",
      },
      {
        title: "Schema Design",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="px-4 py-2 text-sm font-medium rounded-full bg-blue-100 text-[#2D1537]">
              {challenge.level}
            </span>
          </div>
        ...
        <div className="grid gap-8">
          ...
          <section className="bg-white rounded-lg shadow p-6">
            ...
            <ul className="space-y-3">
              {challenge.requirements.map((requirement, index) => (
                <li key={index} className="flex items-start">
                  <svg
                    className="w-6 h-6 text-[#2D1537] mr-2"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <section className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-6">
              {challenge.steps.map((step, index) => (
                <div key={index} className="border-l-4 border-[#2D1537]  pl-4">
          ...
          <div className="mt-8 flex justify-center">
            <button className="px-8 py-3 text-lg font-medium text-white bg-[#2D1537]  rounded-lg hover:bg-[#2D1537]  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              Start Challenge
            </button>
          </div>
        </div>
