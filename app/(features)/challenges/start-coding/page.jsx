...
export default function StartCoding() {
  return (
    <div className="min-h-screen relative">
      ...
      <div className="absolute inset-0 bg-grid-primary/10 bg-[size:20px_20px] pointer-events-none animate-[pulse_4s_ease-in-out_infinite]" />
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-20 space-y-6">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="relative group animate-float">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-500" />
                <span className="relative inline-block px-6 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-primary/10 to-secondary/10 text-primary border border-primary/20 backdrop-blur-sm">
              ...
              <h1 className="text-6xl font-bold leading-tight max-w-4xl mx-auto">
                ...
                <br />
                <span className="bg-gradient-to-r from-secondary via-primary to-purple-500 bg-clip-text text-transparent animate-gradient-reverse">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Join our community of developers and level up your skills with
                hands-on coding challenges. Learn, build, and grow with expert
                guidance.
              </p>

              {/* CTA Buttons */}
              <div className="flex flex-wrap justify-center gap-4 mt-8">
                <Button className="bg-[#2D1537] hover:bg-[#2D1537]/90 text-white px-8 py-6 text-lg rounded-full shadow-lg shadow-[#2D1537]/25 hover:shadow-xl hover:shadow-[#2D1537]/30 transition-all duration-300 transform hover:-translate-y-1">
                  Start Learning Now
                </Button>
                <Button
                  variant="outline"
                  className="px-8 py-6 text-lg rounded-full border-2 hover:bg-primary/5 transition-all duration-300 transform hover:-translate-y-1"
                >
                  Explore Challenges
                </Button>
              </div>
            ...
            <Card className="group relative overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <Link href="/frontend/challenges" passHref legacyBehavior>
                    <Button
                      asChild
                      className="w-full cursor-pointer bg-[#2D1537] hover:bg-[#2D1537]/90 text-white transition-colors"
                    >
                      <a>Start Frontend Challenges</a>
                    </Button>
                  </Link>
                </div>
              </CardContent>
            ...
            <Card className="group relative overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <Link href="/backend/challenges" passHref legacyBehavior>
                    <Button
                      asChild
                      className="w-full bg-[#2D1537] hover:bg-[#2D1537]/90 text-white transition-colors cursor-pointer"
                    >
                      <a>Start Backend Challenges</a>
                    </Button>
                  </Link>
                </div>
              </CardContent>
          ...
          <div className="mt-20 text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                {
                  quote:
                    "The structured approach helped me transition from a beginner to a confident developer.",
              ...
              {[
                {
                  ...
                  description:
                    "Learn by doing with real-world projects and challenges",
                  icon: (
                    <svg
                ...
                },
                {
                  ...
                  description:
                    "Progressive difficulty levels to build your confidence",
                  icon: (
                    <svg
                      className="w-8 h-8 text-primary mx-auto mb-4"
                      fill="none"
                ...
                },
                {
                  ...
                  description:
                    "Learn alongside others and get help when needed",
                  icon: (
                    <svg
                      className="w-8 h-8 text-primary mx-auto mb-4"
                      fill="none"
                ...
                <div
                  key={index}
                  className="p-6 rounded-xl hover:bg-primary/5 transition-colors"
                >
                  {benefit.icon}
          ...
          <div className="mt-20 text-center">
            <div className="inline-block p-8 rounded-2xl bg-gradient-to-br from-primary/5 via-primary/10 to-secondary/5">
              ...
              <Button
                size="lg"
                className="bg-[#2D1537] hover:bg-[#2D1537]/90 text-white"
              >
                Get Started Now
              </Button>
            </div>
