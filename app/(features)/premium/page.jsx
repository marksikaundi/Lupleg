    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-4">
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl">
        <Card className="w-full md:w-1/2 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
          ...
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center">Free Plan</CardTitle>
            <CardDescription className="text-center text-gray-600">Perfect for getting started</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="w-full md:w-1/2 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
          ...
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center">Pro Plan</CardTitle>
            <CardDescription className="text-center text-gray-600">For power users and teams</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center mb-4">
